...
void recognition::calculateDistance( ) {
    ...
    // 左灯条下端点的2D点坐标
    img_points.push_back(cv::Point2f(best_strips_[0].x, best_strips_[0].y + best_strips_[0].height));
    // 右灯条上端点的2D点坐标
    img_points.push_back(cv::Point2f(best_strips_[1].x, best_strips_[1].y));
    // 右灯条下端点的2D点坐标
    img_points.push_back(cv::Point2f(best_strips_[1].x, best_strips_[1].y + best_strips_[1].height));
